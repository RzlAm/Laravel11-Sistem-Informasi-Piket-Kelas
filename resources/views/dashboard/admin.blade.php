    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header pb-0">
          <div class="row">
            <div class="col-md-8">
              <a href="admin/create" class="btn btn-primary"><i class="align-middle" data-feather="plus"></i> Tambah Admin</a>
            </div>
            <div class="col-md-4">
                ...
                @foreach ($data as $item)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="admin/{{ encrypt($item->id) }}/edit" class="btn btn-success btn-sm"><i class="align-middle" data-feather="edit"></i></a>
                    </td>
                  </tr>
                @endforeach
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      deleteButtons.forEach(button => {
        button.addEventListener('click', () => {
          ...
          deleteForm.action = `/dashboard/admin/${id}`;
        });
      });
    });
    ...
    document.querySelectorAll('.btn-delete').forEach(button => {
      button.addEventListener('click', function() {
        ...
        const deleteForm = document.getElementById('deleteForm');
        deleteForm.setAttribute('action', `/dashboard/admin/${itemId}`);
      });
    });
  </script>
@endsection
