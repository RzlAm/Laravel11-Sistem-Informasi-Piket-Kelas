    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header pb-0">
          <div class="row">
            <div class="col-md-8">
              <a href="piket/create" class="btn btn-primary"><i class="align-middle" data-feather="plus"></i> Tambah Data Piket</a>
            </div>
            <div class="col-md-4">
              ...
              <tbody>
                ...
                @foreach ($data as $item)
                  ...
                  <tr>
                    ...
                    <td>{{ substr($item->keterangan, 0, 20) }}</td>
                    <td>
                      ...
                      <a href="piket/{{ encrypt($item->id) }}/edit" class="btn btn-success btn-sm"><i class="align-middle" data-feather="edit"></i></a>
                    </td>
                  </tr>
                @endforeach
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      deleteButtons.forEach(button => {
        button.addEventListener('click', () => {
          ...
          deleteForm.action = `/dashboard/piket/${id}`;
        });
      });
    });
    ...
    document.querySelectorAll('.btn-delete').forEach(button => {
      button.addEventListener('click', function() {
        ...
        const deleteForm = document.getElementById('deleteForm');
        deleteForm.setAttribute('action', `/dashboard/piket/${itemId}`); // Set endpoint untuk hapus
      });
    });
  </script>
@endsection
